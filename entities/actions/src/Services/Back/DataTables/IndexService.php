...
namespace InetStudio\PointsFlowPackage\Actions\Services\Back\DataTables;
...
class IndexService extends DataTable implements IndexServiceContract
{
    ...
    public function ajax(): JsonResponse
    {
        $transformer = app()->make(
            'InetStudio\PointsFlowPackage\Actions\Contracts\Transformers\Back\Resource\IndexTransformerContract'
        );
    ...
    protected function getColumns(): array
    {
        return [
            ...
            ['data' => 'points', 'name' => 'points', 'title' => 'Баллы'],
    ...
    {
        return [
            'url' => route('back.points-flow-package.actions.data.index'),
            'type' => 'POST',
        ];
    }
